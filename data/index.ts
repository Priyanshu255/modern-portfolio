...
export const projects = [
  ...
  },
  {
    ...
    des: "Developed and deployed a full-stack application for a startup company enabling users to make payments.",
...
export const workExperience = [
  {
    ...
    desc: [
      "Built and deployed Smart TV applications (Samsung Tizen & LG Pro:Centric) using React with MQTT-based communication and custom spatial navigation algorithm; enabling scalable, device-agnostic hospitality deployments across 1,000+ rooms in globally recognized 5-star luxury hotels.",
      "Architected backend polling + WebSocket push system in DigiConnect Utility Service, replacing inefficient client polling - improving real-time log handling and reducing network overhead by 60%",
      "Engineered QR-based device mapping system (APC Registration Dashboard).",
  ...
  },
  {
    ...
    title: "SDE Intern",
    desc: [
      "Led development of Sensonic 2.0 Microsoft Teams App, a production-grade visitor management platform using React, GraphQL, and AWS Amplify Cognito; implemented dynamic form architecture and optimized GraphQL cache strategy reducing redundant queries by 40%.",
      "Contributed in real-time animated operational dashboards using React + SVG + Framer Motion for live system monitoring.",
      "Contributed to Angular-based enterprise dashboards using Reactive Forms and PrimeNG, building reusable dynamic components.",
      "Built and deployed Smart TV applications (Samsung Tizen & LG Pro:Centric) using React with MQTT-based communication and custom spatial navigation algorithm; enabling scalable, device-agnostic hospitality deployments across 1,000+ rooms in globally recognized 5-star luxury hotels.",
      // "Contributed to legacy enterprise dashboards built using MERN and MEAN stacks, adding features and resolving bugs in collaboration with team and ship features under agile iterations.",
    ],
    company: "Digivalet",
